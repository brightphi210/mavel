...
const BottomBar = ({isDark, handleLinkClick}:any) => {
  return (
    <div className="flex justify-left " >
        <div className={`${isDark}bg-neutral-800 text-white flex items-center fixed w-[95%] left-3 lg:hidden bottom-3 py-4 px-6 rounded-full backdrop-filter backdrop-blur-3xl bg-opacity-60 `}>
